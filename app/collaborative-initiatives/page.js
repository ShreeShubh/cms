...
const page = () => {
  return (
    <>
      <div className="bg-[url('/collaborativeInitiatives/banner.png')] flex flex-col justify-center md:justify-end h-[420px] md:h-[480px] bg-center bg-cover py-10 md:py-16">
        <Header />
