...
export default function Home() {
  return (
    <>
      <div className="bg-[url('https://s3.ap-south-1.amazonaws.com/com.cg.ivista.mediafiles/cms-origin/cms-website/public/home/banner.png')] flex flex-col justify-center md:justify-end h-[420px] md:[720px] bg-center bg-cover py-10 md:py-16 sm:h-[500px] md:h-[600px] lg:h-[720px]">
        <Header />
