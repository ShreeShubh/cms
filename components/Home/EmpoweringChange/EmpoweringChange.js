...
const EmpoweringChange = () => {
  return (
    <div className="max-w-screen-xl mx-auto w-full mb-12">
      <div className="bg-[url('https://s3.ap-south-1.amazonaws.com/com.cg.ivista.mediafiles/cms-origin/cms-website/public/home/empoweringChange/banner-11.jpeg')] bg-cover w-full h-[300px] sm:h-[400px] md:h-[450px] lg:h-[520px] flex items-center">
