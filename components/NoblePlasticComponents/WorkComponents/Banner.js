...
const Banner = () => {
    return (
        <>
            <div className="lg:bg-[url('https://s3.ap-south-1.amazonaws.com/com.cg.ivista.mediafiles/nobleplasics/work-banner.png')] bg-[#7F3F97] lg:min-h-[680px] bg-center bg-cover bg-no-repeat flex justify-center lg:mt-28">
