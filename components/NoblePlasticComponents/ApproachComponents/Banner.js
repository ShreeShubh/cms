...
const Banner = () => {
  return (
    <>
      <div className="lg:bg-[url('https://s3.ap-south-1.amazonaws.com/com.cg.ivista.mediafiles/nobleplasics/approach/approach-banner.png')] bg-[#7F3F97] lg:min-h-[480px] bg-center bg-cover bg-no-repeat flex justify-center lg:mt-28 mt-28">
        <div className="lg:w-[1140px] w-full p-0 flex flex-col justify-center items-center">
          <div className="grid lg:grid-cols-12 grid-cols-1">
            ...
            <div className="lg:col-span-7 col-span-6 lg:order-2 order-1">
              <img
                src="https://s3.ap-south-1.amazonaws.com/com.cg.ivista.mediafiles/nobleplasics/approach/approach-mobile-banner.png"
