          ...
          <li key={item.id}>
            ...
            >
              ...
              <div className="flex flex-col items-start gap-5 w-[500px]">
                <h2 className="text-3xl text-cms-primary-black font-semibold">
                  {item.title}
                </h2>
                <p className="text-lg text-[#646464]">{item.desc}</p>
                <Link href={item.path}>
                  <button className="border border-cms-primary bg-cms-primary text-white text-lg rounded px-6 py-2">
                    Know more
                  </button>
                </Link>
              </div>
